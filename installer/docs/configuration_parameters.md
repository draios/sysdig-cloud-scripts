...
```yaml
sysdig:
  activityAuditVersion: 4.0.6.10981
```
...
consequences**<br>
**Options**:<br>
**Default**: 4.0.6.10981<br>
**Example**:

```yaml
sysdig:
  monitorVersion: 4.0.6.10981
```
...
```yaml
sysdig:
  sysdigCollectorVersion: 4.0.6.10981
```
...
```yaml
sysdig:
  sysdigWorkerVersion: 4.0.6.10981
```
