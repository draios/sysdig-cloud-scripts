...
```yaml
sysdig:
  activityAuditVersion: 3.6.4.11009
```
...
consequences**<br>
**Options**:<br>
**Default**: 3.6.4.11009<br>
**Example**:

```yaml
sysdig:
  monitorVersion: 3.6.4.11009
```
...
```yaml
sysdig:
  sysdigCollectorVersion: 3.6.4.11009
```
...
```yaml
sysdig:
  sysdigWorkerVersion: 3.6.4.11009
```
