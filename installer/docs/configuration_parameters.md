...
```yaml
sysdig:
  activityAuditVersion: 4.0.7.11006
```
...
consequences**<br>
**Options**:<br>
**Default**: 4.0.7.11006<br>
**Example**:

```yaml
sysdig:
  monitorVersion: 4.0.7.11006
```
...
```yaml
sysdig:
  sysdigCollectorVersion: 4.0.7.11006
```
...
```yaml
sysdig:
  sysdigWorkerVersion: 4.0.7.11006
```
