...
```yaml
sysdig:
  activityAuditVersion: 3.6.1.7758
```
...
consequences**<br>
**Options**:<br>
**Default**: 3.6.1.7758<br>
**Example**:

```yaml
sysdig:
  monitorVersion: 3.6.1.7758
```
...
```yaml
sysdig:
  sysdigCollectorVersion: 3.6.1.7758
```
...
```yaml
sysdig:
  sysdigWorkerVersion: 3.6.1.7758
```
