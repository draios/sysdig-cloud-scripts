...
```yaml
sysdig:
  activityAuditVersion: 4.0.8.12113
```
...
consequences**<br>
**Options**:<br>
**Default**: 4.0.8.12113<br>
**Example**:

```yaml
sysdig:
  monitorVersion: 4.0.8.12113
```
...
```yaml
sysdig:
  sysdigCollectorVersion: 4.0.8.12113
```
...
```yaml
sysdig:
  sysdigWorkerVersion: 4.0.8.12113
```
