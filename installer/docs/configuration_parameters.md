...
consequences**<br>
**Options**:<br>
**Default**: 5.0.1.10735<br>
**Example**:

```yaml
sysdig:
  monitorVersion: 5.0.1.10735
```
...
```yaml
sysdig:
  sysdigCollectorVersion: 5.0.1.10735
```
...
```yaml
sysdig:
  sysdigWorkerVersion: 5.0.1.10735
```
